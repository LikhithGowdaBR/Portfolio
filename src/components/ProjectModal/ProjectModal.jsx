            ...
            <div className="mt-4 flex flex-col sm:flex-row gap-3">
                {project.liveUrl && (
                    <a
                        ...
                        className="inline-flex items-center justify-center gap-2 font-semibold bg-violet-600 p-3 px-5 rounded-full flex-1 cursor-pointer border border-transparent hover:bg-violet-700 transition-colors"
                    >
                        <FiExternalLink />
                        <span>Live Demo</span>
                    </a>
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`inline-flex items-center justify-center gap-2 font-semibold p-3 px-5 rounded-full flex-1 cursor-pointer border transition-colors ${
                        project.liveUrl
                            ? "bg-zinc-800 border-zinc-700 hover:bg-zinc-700"
                            : "bg-violet-600 border-transparent hover:bg-violet-700"
                    }`}
                >
                    <FiGithub />
