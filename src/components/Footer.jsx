    ...
    <div className="mt-32 pb-8 flex flex-col items-center relative z-10">
      ...
      <div className="w-full flex flex-col md:flex-row items-center md:justify-between gap-6">
        ...
        <div className="flex gap-3 order-2 md:order-none">
          <a href="https://github.com/LikhithGowdaBR" target="_blank" rel="noreferrer"><i className="ri-github-fill ri-2x"></i></a>
          <a href="https://www.linkedin.com/in/likhith-gowda-b-r-288060305" target="_blank" rel="noreferrer"><i className="ri-linkedin-box-fill ri-2x"></i></a>
          <a href="mailto:likhithgowda08052005@gmail.com"><i className="ri-mail-fill ri-2x"></i></a>
        </div>
